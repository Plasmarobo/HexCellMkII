...
void HAL_I2C_MspInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  if (i2cHandle->Instance == I2C1)
  {
    ...
    PB7     ------> I2C1_SDA
    */
    GPIO_InitStruct.Pin       = BUS_SCL_IN_Pin | BUS_SDA_IN_Pin;
  ...
  else if (i2cHandle->Instance == I2C2)
  {
    ...
    PA11     ------> I2C2_SCL
    */
    GPIO_InitStruct.Pin       = BUS_SDA_OUT_Pin;
    GPIO_InitStruct.Mode      = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull      = GPIO_NOPULL;
    GPIO_InitStruct.Speed     = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF5_I2C2;
    HAL_GPIO_Init(BUS_SDA_OUT_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin       = BUS_SCL_OUT_Pin;
    GPIO_InitStruct.Mode      = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull      = GPIO_NOPULL;
    GPIO_InitStruct.Speed     = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF5_I2C2;
    HAL_GPIO_Init(BUS_SCL_OUT_GPIO_Port, &GPIO_InitStruct);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  if (i2cHandle->Instance == I2C1)
  {
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(BUS_SCL_IN_GPIO_Port, BUS_SCL_IN_Pin);

    HAL_GPIO_DeInit(BUS_SDA_IN_GPIO_Port, BUS_SDA_IN_Pin);
  ...
  else if (i2cHandle->Instance == I2C2)
  {
    ...
    PA11     ------> I2C2_SCL
    */
    HAL_GPIO_DeInit(BUS_SDA_OUT_GPIO_Port, BUS_SDA_OUT_Pin);

    HAL_GPIO_DeInit(BUS_SCL_OUT_GPIO_Port, BUS_SCL_OUT_Pin);
